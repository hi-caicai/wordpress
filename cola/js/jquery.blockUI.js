...
function popBlockUI(blockId){
	var thisElement = $("#" + blockId);
	var maxWidth = $(window).width();
	var maxHeight = $(window).height();
	var thisWidth = thisElement.width();
	var thisHeight = thisElement.height();
	var thisLeft = (maxWidth-thisWidth)/2;
	var thisTop = (maxHeight-thisHeight)/2+$(window).scrollTop();
	$.blockUI({
		message:thisElement,
		css:{
			width:thisWidth,
